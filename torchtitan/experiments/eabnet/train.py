...
class EABNetTrainer(Trainer):
    ...
    def forward_backward_step(
        ...
        target_stft = stft_then_sqrt_comp(labels, False, **self.stft_params)
        noisy_stft  = stft_then_sqrt_comp(input_dict['noisy'],  True,  **self.stft_params)
        ...
        loss = self.loss_fn(esti_stft, target_stft)
        # pred.shape=(bs, seq_len, vocab_size)
        # need to free to before bwd to avoid peaking memory
        del (esti_stft, noisy_stft, target_stft)
        loss.backward()
