...
__all__ = [
    "GSLRSchedulersContainer",
    "build_lr_schedulers",
]


class GradScalerScheduler:
    """
    ...
    def __init__(self, scheduler, optimizer, step_with_optimizer: bool = True):
    ...
    def step(self, *args, **kwargs):
        ...
        if self.optimizer.step_was_skipped:
            return
...
class GSLRSchedulersContainer(LRSchedulersContainer):
    ...
    def __init__(self, optimizers: OptimizersContainer, lr_lambda: Callable) -> None:
        ...
        self.schedulers = [GradScalerScheduler(LambdaLR(optimizer, lr_lambda),
...
def build_lr_schedulers(
    ...
    **Note**
    ...
    return GSLRSchedulersContainer(optimizers, lr_lambda)
